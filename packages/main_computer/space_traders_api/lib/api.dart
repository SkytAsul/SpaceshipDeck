...
part 'model/activity_level.dart';
part 'model/agent.dart';
part 'model/agent_event.dart';
part 'model/chart.dart';
part 'model/chart_transaction.dart';
part 'model/construction.dart';
part 'model/construction_material.dart';
...
part 'model/dock_ship200_response_data.dart';
...
part 'model/get_agent200_response.dart';
...
part 'model/get_error_codes200_response.dart';
part 'model/get_error_codes200_response_error_codes_inner.dart';
...
part 'model/get_my_account200_response.dart';
part 'model/get_my_account200_response_data.dart';
part 'model/get_my_account200_response_data_account.dart';
part 'model/get_my_agent200_response.dart';
part 'model/get_my_agent_events200_response.dart';
part 'model/get_my_factions200_response.dart';
part 'model/get_my_factions200_response_data_inner.dart';
...
part 'model/get_repair_ship200_response.dart';
part 'model/get_repair_ship200_response_data.dart';
...
part 'model/get_status200_response_health.dart';
...
part 'model/negotiate_contract201_response.dart';
part 'model/negotiate_contract201_response_data.dart';
part 'model/orbit_ship200_response.dart';
part 'model/patch_ship_nav200_response.dart';
part 'model/patch_ship_nav_request.dart';
part 'model/public_agent.dart';
part 'model/purchase_cargo201_response.dart';
part 'model/purchase_cargo201_response_data.dart';
...
part 'model/refuel_ship_request.dart';
...
part 'model/remove_ship_module201_response.dart';
...
part 'model/scrap_ship200_response.dart';
part 'model/scrap_ship200_response_data.dart';
part 'model/scrap_transaction.dart';
...
part 'model/ship_condition_event.dart';
...
part 'model/ship_modification_transaction.dart';
...
part 'model/ship_refine201_response.dart';
part 'model/ship_refine201_response_data.dart';
part 'model/ship_refine201_response_data_produced_inner.dart';
...
part 'model/siphon.dart';
part 'model/siphon_resources201_response.dart';
part 'model/siphon_resources201_response_data.dart';
part 'model/siphon_yield.dart';
part 'model/supply_construction201_response.dart';
part 'model/supply_construction201_response_data.dart';
part 'model/supply_construction_request.dart';
part 'model/supply_level.dart';
part 'model/survey.dart';
part 'model/survey_deposit.dart';
part 'model/survey_size.dart';
...
part 'model/transfer_cargo200_response_data.dart';
...
part 'model/waypoint_modifier_symbol.dart';
